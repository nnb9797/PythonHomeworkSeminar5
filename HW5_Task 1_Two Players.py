...
def input_sweets(name):
    taken = int(input(f"Игрок {name}, введите количество конфет, которое хотите взять, от 1 до 28: "))
    while taken < 1 or taken > 28:
        taken = int(input(f"Игрок {name}, введите корректное количество конфет от 1 до 28: "))
    return taken
